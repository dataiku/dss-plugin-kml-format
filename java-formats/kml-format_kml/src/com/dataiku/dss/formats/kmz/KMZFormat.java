...
public class KMZFormat implements CustomFormat {
    /**
    ...
    public CustomFormatSchemaDetector getDetector(JsonObject config, JsonObject pluginConfig) {
        return new KMZFormatDetector();
    }

    public  class KMZFormatInput implements CustomFormatInput {
        /**
...
*/
    ...
    public static class KMZFormatOutput implements CustomFormatOutput {
        @Override
        public void close() throws IOException {
        }
    ...
    public static class KMZFormatDetector implements CustomFormatSchemaDetector {
        @Override
